...
public:
    ...
    //Constructor
    Section() : s_type(NONE), section_name(), virt_address(0), load_address(0), section_size(0), section_rsize(0), bytes(nullptr) {}
